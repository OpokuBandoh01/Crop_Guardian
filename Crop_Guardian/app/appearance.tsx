  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={[styles.headerTitle, { color: theme.primary }]}>Appearance</Text>
      ...
      >
        ...
        {showSuccess && (
          <View style={styles.successBanner}>
            ...
            <Text style={styles.successText}>Theme preferences saved successfully!</Text>
          </View>
        )}
        ...
        <View style={styles.illustrationHeader}>
          ...
          <Text style={[styles.screenTitleText, { color: theme.text }]}>Choose Your Theme</Text>
          <Text style={[styles.screenSubtitleText, { color: colorScheme === 'light' ? '#687076' : '#9BA1A6' }]}>
            Personalize your viewing experience. Dark mode helps save battery life in fields with low light.
          </Text>
        </View>
        ...
        <View style={styles.themesRow}>
          ...
          <TouchableOpacity
            style={[
              ...
              selectedTheme === 'light' ? styles.themeCardActive : styles.themeCardInactive,
            ]}
            onPress={() => setSelectedTheme('light')}
            activeOpacity={0.9}
          >
            {/* Light Mode Mock Design */}
            ...
            <View style={styles.cardInfoRow}>
              <Text style={[styles.themeLabel, { color: theme.text }]}>Light Mode</Text>
              <View style={[
                styles.radioOuter,
                selectedTheme === 'light' ? styles.radioOuterSelected : styles.radioOuterUnselected
              ]}>
          ...
          <TouchableOpacity
            style={[
              styles.themeCard,
              { backgroundColor: theme.surface },
              selectedTheme === 'dark' ? styles.themeCardActive : styles.themeCardInactive,
            ]}
            onPress={() => setSelectedTheme('dark')}
            activeOpacity={0.9}
          >
            {/* Dark Mode Mock Design */}
            <View style={[styles.mockPhone, { backgroundColor: '#151718' }]}>
              <View style={[styles.mockHeader, { backgroundColor: '#1F2937' }]} />
              <View style={[styles.mockCard, { backgroundColor: '#2E3D30' }]} />
              <View style={[styles.mockLine, { backgroundColor: '#4B5563' }]} />
              <View style={[styles.mockLine, { width: '50%', backgroundColor: '#4B5563' }]} />
            </View>
            ...
            <View style={styles.cardInfoRow}>
              ...
              <View style={[
                styles.radioOuter,
                selectedTheme === 'dark' ? styles.radioOuterSelected : styles.radioOuterUnselected
              ]}>
          ...
          >
            <View style={styles.optionLeft}>
              ...
              <View style={styles.optionTextContainer}>
                <Text style={[styles.optionTitle, { color: theme.text }]}>Use System Settings</Text>
                <Text style={[styles.optionSub, { color: colorScheme === 'light' ? '#687076' : '#9BA1A6' }]}>
            ...
            <View style={[
              styles.radioOuter,
              selectedTheme === 'system' ? styles.radioOuterSelected : styles.radioOuterUnselected
            ]}>
...
const styles = StyleSheet.create({
  ...
  // Mock phone screens inside cards
  mockPhone: {
